...
- SoundCase oferece voz Grok Realtime experimental somente para leitura de texto, com token temporário no navegador; TTS e arquivo OpenAI permanecem. QA isolado usa `GAUCHO_ISOLATED_RUNTIME=true` para não limpar units Studio da produção.
