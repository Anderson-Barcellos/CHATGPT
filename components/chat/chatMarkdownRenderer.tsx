...
interface ChatMarkdownComponentOptions {
  renderMermaid?: boolean;
}

export function createChatMarkdownComponents({
  renderMermaid = true,
}: ChatMarkdownComponentOptions = {}): Components {
  const renderCode: Components["code"] = ({
    ...
    if (!isInline && language.toLowerCase() === "mermaid" && renderMermaid) {
...
export const chatMarkdownComponents = createChatMarkdownComponents();
