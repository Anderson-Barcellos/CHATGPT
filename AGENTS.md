...
- QA em outra instância Next deve usar `GAUCHO_ISOLATED_RUNTIME=true` para não executar cleanup de units Studio da produção. Build e dados de teste continuam isolados; a flag não deve entrar no serviço principal.
